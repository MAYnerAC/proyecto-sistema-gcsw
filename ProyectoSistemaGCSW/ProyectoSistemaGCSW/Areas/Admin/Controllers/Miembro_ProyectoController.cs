...
namespace ProyectoSistemaGCSW.Areas.Admin.Controllers
{
    public class Miembro_ProyectoController : Controller
    {
        ...
        // GET: Admin/Miembro_Proyecto
        public ActionResult Index()
        {
            var miembro_Proyecto = db.Miembro_Proyecto.Include(m => m.Proyecto).Include(m => m.Rol).Include(m => m.Usuario);
            return View(miembro_Proyecto.ToList());
        }

        // GET: Admin/Miembro_Proyecto/Details/5
        ...
        // GET: Admin/Miembro_Proyecto/Create
        ...
        // POST: Admin/Miembro_Proyecto/Create
        ...
        // GET: Admin/Miembro_Proyecto/Edit/5
        ...
        // POST: Admin/Miembro_Proyecto/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que quiere enlazarse. Para obtener 
        // más detalles, vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/Miembro_Proyecto/Delete/5
        ...
        // POST: Admin/Miembro_Proyecto/Delete/5
