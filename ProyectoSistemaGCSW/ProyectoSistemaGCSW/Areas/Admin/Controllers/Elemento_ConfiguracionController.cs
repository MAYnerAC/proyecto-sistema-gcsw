...
namespace ProyectoSistemaGCSW.Areas.Admin.Controllers
{
    public class Elemento_ConfiguracionController : Controller
    {
        ...
        // GET: Admin/Elemento_Configuracion
        public ActionResult Index()
        {
            var elemento_Configuracion = db.Elemento_Configuracion.Include(e => e.Fase).Include(e => e.Proyecto);
            return View(elemento_Configuracion.ToList());
        }

        // GET: Admin/Elemento_Configuracion/Details/5
        ...
        // GET: Admin/Elemento_Configuracion/Create
        ...
        // POST: Admin/Elemento_Configuracion/Create
        ...
        // GET: Admin/Elemento_Configuracion/Edit/5
        ...
        // POST: Admin/Elemento_Configuracion/Edit/5
        // Para protegerse de ataques de publicación excesiva, habilite las propiedades específicas a las que quiere enlazarse. Para obtener 
        // más detalles, vea https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/Elemento_Configuracion/Delete/5
        ...
        // POST: Admin/Elemento_Configuracion/Delete/5
