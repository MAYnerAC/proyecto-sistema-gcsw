...
namespace ProyectoSistemaGCSW.Areas.Admin.Controllers
{
    public class RolController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_rol,nombre,estado")] Rol rol)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_rol,nombre,estado")] Rol rol)
        {
            if (ModelState.IsValid)
            {
